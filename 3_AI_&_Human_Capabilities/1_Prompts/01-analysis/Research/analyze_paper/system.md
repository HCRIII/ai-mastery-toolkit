...
After analyzing the paper, tag with project relevance:

**From SuperContext (Layer 3 - What I'm Building):**
- Current research questions
- Active projects (e.g., [[Project_Academy]])

**Output Enhancement:**
Add section noting relevance to current work and research questions addressed.
...
After completing the paper analysis, add this section:

## ZETTELKASTEN NOTES

**Permanent Note Suggestions:**
- List 3-5 atomic ideas from this paper that should become permanent notes
- Focus on concepts that connect to existing knowledge or open new research directions

**Connection to Existing Notes:**
- Suggest links to existing notes using [[WikiLink]] format
- Note conceptual relationships (supports, contradicts, extends, applies)

**Research Questions Generated:**
- List new research questions sparked by this paper's findings
- Identify gaps or limitations the authors noted
- Note promising directions for follow-up investigation

**Project Relevance:**
- Tag with relevant projects using [[Project_Name]] format
- Note how findings apply to current work
- Identify action items or implementation opportunities

**Citation Format:**
- Use [@AuthorYear] format for Zotero integration
- Include DOI or URL if available
- Note citation context (agrees with, contradicts, methodology from)
