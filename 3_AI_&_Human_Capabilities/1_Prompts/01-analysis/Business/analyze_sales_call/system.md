...
Before analyzing the sales call, load:

**From Life & Business Context:**
- Doc 13 (Trusted Advisor Framework) - Advisory approach
- Doc 14 (Coaching Session Protocol) - Session standards

**From SuperContext (Layer 2):**
- Communication style: Calibrated Directness
- Core differentiator: Depth + Warmth

**Use this context to:**
- Evaluate alignment with Trusted Advisor approach
- Assess application of Calibrated Directness
- Rate authenticity and protective guardian stance
