...
Before creating user stories, load:

**From SuperContext (Layer 3 - What I'm Building):**
- Current project context (e.g., Cognitive Academy Launch)
- User personas if defined
- Project goals and success criteria

**Use this context to:**
- Align stories with current project objectives
- Reference established user personas
- Ensure stories serve project goals
...
I'll migrate email templates over to Mustache
