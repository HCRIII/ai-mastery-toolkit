...
Before creating the PRD, load relevant business context:

**From SuperContext (Layer 3 - What I'm Building):**
- Current active projects and their strategic goals
- Week in 20-week roadmap (for timeline alignment)
- Capacity constraints (25 hrs/week allocation)

**From Life & Business Context:**
- Doc 9 (Key Message Platform) - Value proposition alignment
- Doc 10 (Brand Guidelines) - Visual/branding requirements
- Doc 12 (Ideal Client Profile) - Target user context

**Use this context to:**
- Align PRD objectives with current strategic direction
- Reference existing project dependencies
- Ensure realistic timelines given capacity
- Frame user needs around Ideal Client Profile
