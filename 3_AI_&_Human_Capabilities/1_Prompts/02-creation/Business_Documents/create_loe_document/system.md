...
Before creating the Level of Effort document, load:

**From SuperContext:**
- Current capacity: 25 hrs/week for strategic projects
- Active projects and resource allocation
- Current phase in project roadmap

**Use this context to:**
- Ensure realistic effort estimates given current capacity
- Account for existing project commitments
- Align timelines with strategic priorities
