...
Before creating the Hormozi offer, load:

**From Life & Business Context:**
- Doc 9 (Key Message Platform) - Value proposition
- Doc 12 (Ideal Client Profile) - Target market definition
- Doc 10 (Brand Guidelines) - Brand positioning

**From SuperContext (Layer 2):**
- Core differentiator: Depth + Warmth, Calibrated Directness
- Unique positioning as protective guardian

**Use this context to:**
- Frame offer around unique value proposition
- Target Ideal Client Profile specifically
- Align with brand positioning and messaging
