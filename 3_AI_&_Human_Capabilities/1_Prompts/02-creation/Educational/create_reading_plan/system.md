...
After creating the reading plan, add this section:

## ZETTELKASTEN NOTES

**Knowledge Building Strategy:**
- Map how each phase builds on the previous
- Identify core concepts that appear across multiple books
- Note thematic progression through the reading plan

**Note-Taking Approach by Phase:**
- PHASE 1: Focus on foundational permanent notes, key concepts, author's framework
- PHASE 2: Build connections between core ideas, comparative analysis notes
- PHASE 3: Synthesis notes, application ideas, personal insights

**Citation Management:**
- Use [@AuthorYear] format for all recommended books
- Create bibliography entries for Zotero integration
- Note editions, translations, or specific versions recommended

**Project Application:**
- Tag reading plan with relevant projects using [[Project_Name]]
- Identify how each phase supports specific project goals
- Note milestones for applying knowledge to real work

**Research Questions:**
- List questions to explore while reading each phase
- Identify themes to track across multiple books
- Note synthesis opportunities between authors

**Connection Points:**
- Suggest existing notes that this reading plan extends
- Identify concepts that will bridge current knowledge gaps
- Note where this plan intersects with other learning goals
